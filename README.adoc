...
This repository is a fork of https://github.com/ghillert/spring-boot-jsp-demo (deleted ...) itself a fork of https://github.com/joakime/spring-boot-jsp-demo, I have just added the gradle parts for jetty.
